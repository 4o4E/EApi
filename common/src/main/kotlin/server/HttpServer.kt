package top.e404.eapi.common.server
...
import top.e404.eapi.common.config.RouterConfig
        ...
        server = embeddedServer(CIO, config.server.port) {
            ...
            routing {
                for (routerConfig in config.routers) {
                    ...
                    EApiCommon.instance.debug { "注册 ${routerConfig.path}" }
            ...
            try {
                ...
                val bindings = SimpleBindings(
                    mutableMapOf<String, Any>(
                        *EApiCommon.instance.jsModules,
                        *EApiCommon.instance.config.nashorn.varArray,
                ...
                EApiCommon.instance.warn("执行路由脚本时发生错误", e)
                call.respondText(
                    "执行脚本发生错误: ${e.message}",
                    ContentType.Text.Plain,
